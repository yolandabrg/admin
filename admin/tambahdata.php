                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" name="namakuliner" class="form-control" placeholder="Nama Kuliner">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon">
                                                        <input type="text" name="hargakuliner" class="form-control" placeholder="Harga Kuliner (Tanpa RP)">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon">
                                                        <input type="text" name="lokasikuliner" class="form-control" placeholder="Lokasi Kuliner">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon">
                                                        <input type="text" name="deskripsikuliner" class="form-control" placeholder="Deskripsi Kuliner">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon">
